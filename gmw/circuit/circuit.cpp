...
CCircuit* CREATE_CIRCUIT(int nParties, const string& name, const vector<int>& params)
{
	...
	else if( name == "set-union" )
	{
		pCircuit = new CGrouping();
	}
	...
	}else if( name == "hamming-sort")
	{
		pCircuit = new CHammSorting();

	}else if( name == "hamming-sort2")
	{
		pCircuit = new CHammSorting2();
	}
/*
	else if ( name == "cloud" )
	{
...
*/
	...
	else if ( name == "test-sorting")
	{

		pCircuit = new CTestSortingCircuit();
	}
	else if(name=="hamm-sorting")
	{
		pCircuit = new CHammSorting();
	}
	else if ( name == "hammsort-ref")
	{
		pCircuit = new CHammSortRef();
	}
	if(pCircuit)
	{
	...
	cout << "Total=" << pCircuit->p_totalGates << endl;

	cout << "Diff AND=" << 2147483648-(pCircuit->GetNumANDs()) << endl;
	cout << "Diff Total=" << 2147483648 - pCircuit->p_totalGates << endl;
	return pCircuit;
}
//*************************************************************************//
...
{
	cout << "output:"  << endl;
	//cout << "m_nFrontier: " << CCircuit::m_nFrontier << endl;
